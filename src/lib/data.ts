// Datos para los dones espirituales
export const donesEspirituales = [
  {
    id: 1,
    nombre: "Administración",
    descripcion: "La capacidad de organizar tareas y personas para lograr objetivos en la obra de Dios.",
    referenciasBiblicas: "1 Corintios 12:28, Romanos 12:8",
    icono: "clipboard-list"
  },
  {
    id: 2,
    nombre: "Exhortación",
    descripcion: "La habilidad de animar, consolar y motivar a otros a vivir una vida cristiana plena.",
    referenciasBiblicas: "Romanos 12:8",
    icono: "heart"
  },
  {
    id: 3,
    nombre: "Evangelismo",
    descripcion: "La capacidad de comunicar el mensaje de salvación a los no creyentes de manera efectiva.",
    referenciasBiblicas: "Efesios 4:11",
    icono: "message-square"
  },
  {
    id: 4,
    nombre: "Hospitalidad",
    descripcion: "El don de hacer sentir bienvenidos a otros y atender sus necesidades con generosidad.",
    referenciasBiblicas: "1 Pedro 4:9-10",
    icono: "home"
  },
  {
    id: 5,
    nombre: "Intercesión",
    descripcion: "La capacidad de orar por otros con perseverancia y ver resultados concretos.",
    referenciasBiblicas: "Colosenses 4:12, 1 Timoteo 2:1-2",
    icono: "hands-praying"
  },
  {
    id: 6,
    nombre: "Liderazgo",
    descripcion: "La habilidad de inspirar y guiar a otros hacia el cumplimiento de la visión de Dios.",
    referenciasBiblicas: "Romanos 12:8, 1 Timoteo 5:17",
    icono: "users"
  },
  {
    id: 7,
    nombre: "Misericordia",
    descripcion: "La capacidad de mostrar compasión práctica hacia aquellos que sufren o están necesitados.",
    referenciasBiblicas: "Romanos 12:8",
  ...
  },
  {
    id: 8,
    nombre: "Enseñanza",
    descripcion: "La habilidad de explicar las verdades bíblicas de manera clara y aplicable a la vida.",
    referenciasBiblicas: "Romanos 12:7, 1 Corintios 12:28",
    icono: "book-open"
  },
  {
    id: 9,
    nombre: "Servicio",
    descripcion: "La disposición de ayudar a otros en tareas prácticas con alegría y humildad.",
    referenciasBiblicas: "Romanos 12:7, 1 Pedro 4:11",
    icono: "helping-hand"
  },
  {
    id: 10,
    nombre: "Pastorado",
    descripcion: "La capacidad de cuidar, guiar y nutrir el crecimiento espiritual de un grupo de creyentes.",
    referenciasBiblicas: "Efesios 4:11",
    icono: "users-round"
  },
  {
    id: 11,
    nombre: "Predicación",
    descripcion: "La habilidad de comunicar la Palabra de Dios con claridad, autoridad y relevancia.",
    referenciasBiblicas: "Romanos 12:6, 1 Pedro 4:11",
    icono: "megaphone"
  },
  {
    id: 12,
    nombre: "Profecía",
    descripcion: "La capacidad de recibir y comunicar mensajes divinos con claridad y autoridad.",
    referenciasBiblicas: "Romanos 12:6, 1 Corintios 12:10",
    icono: "sparkles"
  },
  {
    id: 13,
...
export const testimonios = [
  {
    ...
    testimonio: "Descubrir mi don de exhortación ha transformado la manera en que aconsejo a otros en mi comunidad. Ahora veo las situaciones con una claridad espiritual que nunca antes tuve.",
    don: "Exhortación",
    imagen: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200&auto=format&fit=crop"
  },
  {
    id: 2,
    nombre: "Jaime Wilson",
    testimonio: "Mi don de fe me ha sostenido en situaciones imposibles. Cuando otros ven obstáculos, yo veo oportunidades para que Dios haga milagros.",
    don: "Intercesión",
    imagen: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop"
  },
  {
    id: 3,
    nombre: "Sara Jiménez",
    testimonio: "Usar mi don de discernimiento ha ayudado a nuestra iglesia a navegar decisiones complejas y evitar trampas espirituales que no eran obvias para otros.",
    don: "Profecía",
    imagen: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200&auto=format&fit=crop"
  }
];
...
export const recursos = [
  {
    id: 1,
    titulo: "Descubriendo tus Dones Espirituales",
    tipo: "Libro",
    descripcion: "Una guía completa para entender e identificar tus dones espirituales únicos.",
    enlace: "#",
    imagen: "https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=200&auto=format&fit=crop"
  },
  {
    id: 2,
    titulo: "El Propósito de los Dones Espirituales",
    tipo: "Video",
    descripcion: "Una enseñanza perspicaz sobre cómo los dones espirituales están destinados a edificar la comunidad de fe.",
    enlace: "#",
    imagen: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?q=80&w=200&auto=format&fit=crop"
  },
  {
    id: 3,
    titulo: "Dones Espirituales en el Mundo Moderno",
    tipo: "Artículo",
    descripcion: "Cómo aplicar conceptos espirituales antiguos en contextos contemporáneos.",
    enlace: "#",
    imagen: "https://images.unsplash.com/photo-1471970471555-19d4b113e9ed?q=80&w=200&auto=format&fit=crop"
  }
];
...
export const preguntasTest = [
  ...
  "Puedo ver cómo organizar mejor las cosas en un grupo.",
  "Sé delegar tareas a las personas correctas en el momento justo.",
  ...
  "Sé consolar a las personas cuando están tristes o necesitan apoyo.",
  "Mis palabras suelen inspirar a otros a seguir adelante.",
  ...
  "Siento tristeza cuando alguien no conoce a Cristo y quiero cambiar eso.",
  "Puedo explicar sobre Jesús de una forma clara para los que no creen.",
  "Quiero que más gente conozca a Jesús y sé cómo hablarles de él.",
  ...
  "Tengo un cariño especial por los que llegan a mi casa como visitas.",
  "Mi casa siempre está abierta para quien necesite un lugar donde quedarse.",
  ...
  "Si alguien me pide oración, lo hago con alegría y no lo olvido.",
  "Me encantaría ser el compañero de oración de alguien en su trabajo para Dios.",
  "Siento que ayudo a otros cuando oro por ellos con fe.",
  ...
  "Si formo parte de un grupo, me doy cuenta rápido si algo no funciona bien.",
  "He liderado un grupo y lo he guiado bien hacia una meta.",
  "Puedo liderar y motivar a otros para que trabajen juntos por Dios.",
  ...
  "Me gusta visitar y ayudar a los que están enfermos o solos.",
  "Puedo darme cuenta cuando alguien está sufriendo y quiero ayudarlo.",
  "Mis visitas a enfermos o necesitados les dan fuerza espiritual.",
  ...
  "Dios me ha usado para enseñar la Biblia y animar a otros a crecer.",
  "Puedo captar el interés de las personas cuando enseño algo.",
  "Me gusta compartir lo que sé de la Biblia para que otros crezcan.",
  ...
  "Quiero tener más oportunidades para ayudar a otros en lo que hacen por Dios.",
  "Siempre encuentro formas prácticas de ayudar y me siento bien haciéndolo.",
  ...
  "Me gustaría entrenar a otros cristianos para que sirvan mejor a Dios.",
  "He ayudado a otros cristianos a madurar en su fe con buenos resultados.",
  ...
  "Creo que puedo transmitir el mensaje de Dios con poder.",
  "He visto que mis palabras sobre la fe mueven a otros a actuar.",
  "Quiero aprender a predicar con claridad y autoridad.",
  ...
  "Siento que mis palabras ayudan a otros a alinear sus vidas con la fe.",
  "Quiero desafiar a otros a vivir una vida más santa.",
  "He sentido que Dios me habla y he compartido sus mensajes con otros.",
  "Sé escuchar a Dios y compartir mensajes especiales que Él me da.",
  "He sentido una guía clara de Dios para hablarle a alguien.",
  "A veces siento que Dios me muestra cosas que van a pasar.",
  ...
  "Quiero aprender a orar con fe por la salud de otros.",
...
export const categoriasDones = {
  "Administración": [0, 1, 2, 3, 4, 5, 6, 7],
  "Exhortación": [8, 9, 10, 11, 12, 13, 14, 15],
  "Evangelismo": [16, 17, 18, 19, 20, 21, 22, 23, 24],
  "Hospitalidad": [25, 26, 27, 28, 29, 30, 31, 32],
  "Intercesión": [33, 34, 35, 36, 37, 38, 39, 40, 41],
...
export const descripcionesDones = {
  "Administración": "El don de administración te permite organizar tareas y personas para lograr objetivos en la obra de Dios. Tienes la capacidad de planificar, coordinar y ejecutar proyectos de manera efectiva.",
  "Exhortación": "El don de exhortación te permite animar, consolar y motivar a otros a vivir una vida cristiana plena. Sabes cómo inspirar a otros cuando están desanimados.",
  "Evangelismo": "El don de evangelismo te permite comunicar el mensaje de salvación a los no creyentes de manera efectiva. Tienes una pasión especial por compartir el evangelio.",
  "Hospitalidad": "El don de hospitalidad te permite hacer sentir bienvenidos a otros y atender sus necesidades con generosidad. Tu hogar es un lugar de refugio y consuelo para otros.",
  "Intercesión": "El don de intercesión te permite orar por otros con perseverancia y ver resultados concretos. Tienes una conexión especial con Dios a través de la oración.",
  "Liderazgo": "El don de liderazgo te permite inspirar y guiar a otros hacia el cumplimiento de la visión de Dios. Sabes cómo motivar a un equipo para alcanzar metas importantes.",
  "Misericordia": "El don de misericordia te permite mostrar compasión práctica hacia aquellos que sufren o están necesitados. Tienes una sensibilidad especial hacia el dolor ajeno.",
  "Enseñanza": "El don de enseñanza te permite explicar las verdades bíblicas de manera clara y aplicable a la vida. Sabes cómo hacer que conceptos complejos sean entendibles.",
  "Servicio": "El don de servicio te permite ayudar a otros en tareas prácticas con alegría y humildad. Encuentras satisfacción en apoyar a otros en sus necesidades.",
